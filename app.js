...
var completedTasksHolder=document.querySelector(".todo__list-complete");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.className='btn__delete__img';
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("todo__list__item_edit-mode");
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    if (listItem.classList.contains('todo__list__item_edit-mode')) {
      listItem.className = "todo__list-complete__item todo__list__item_edit-mode";
    } else {
      listItem.className = "todo__list-complete__item";
    }
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    if (listItem.classList.contains('todo__list__item_edit-mode')) {
      listItem.className = "todo__list__item todo__list__item_edit-mode";
    } else {
      listItem.className = "todo__list__item";
    }
    incompleteTaskHolder.appendChild(listItem);
